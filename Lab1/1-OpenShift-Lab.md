...
```bash
[labuser01@master ~]$ oc new-app https://github.com/sclorg/nodejs-ex -l name=myapp01
--> Found image 0d01232 (4 months old) in image stream "openshift/nodejs" under tag "10" for "nodejs"
...
Please note that in Openshift You may use the kubectl command as well:
...
nodejs-ex          nodejs-ex-labproj01.apps.x.cloudpak.site                    nodejs-ex          8080-tcp                 None
...
``` 
nodejs-ex-labproj01.apps.x.cloudpak.site
```
